...
class DeadworldSeeder extends Seeder
{
    public function run($projects): void
    {
		...
		// $species_list = [];
		// $json = File::get(database_path('data/deadworld/species.json'));
		...
		$locations = [];
		$json = File::get(database_path('data/deadworld/locations.json'));
		...
		$characters = [];
		$json = File::get(database_path('data/deadworld/characters.json'));
		...
		// $factions = [];
		// $ranks = [];
		// $json = File::get(database_path('data/deadworld/factions.json'));
		...
		// $relationships = [];
		// $json = File::get(database_path('data/deadworld/relationships.json'));
