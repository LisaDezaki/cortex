...
class FalloutSeeder extends Seeder
{
    public function run($projects): void
    {
		...
		$items = [];
		$json = File::get(database_path('data/fallout/items.json'));
		...
		$characters = [];
		$json = File::get(database_path('data/fallout/characters.json'));
		...
		// $factions = [];
		// $ranks = [];
		// $json = File::get(database_path('data/fallout/factions.json'));
		...
		// $relationships = [];
		// $json = File::get(database_path('data/fallout/relationships.json'));
