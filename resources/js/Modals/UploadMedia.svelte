...
{...restProps}>
	...
	<UploadContext name="media" {type} {multiple} {aspect}>
		...
		{#if !multiple}
			...
			<UploadPreview index={0} navigable={false} class="relative flex items-center justify-center overflow-hidden w-full {aspect} hover:inner-shadow-lg transition-all">
