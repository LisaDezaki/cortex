				...
				<Grid cols={2} gap={12}>
					...
					<Stack gap={0}>
						<Flex align="center" gap={1.5}>
							...
							<Button size="xl" style="soft" theme="accent" icon="Pen"   iconSize="lg" iconWeight="light" onclick={() => active.openModal('rename')} class="p-2 rounded-full ml-auto" />
							<Button size="xl" style="soft" theme="danger" icon="Trash" iconSize="lg" iconWeight="light" onclick={() => active.openModal('delete')} class="p-2 rounded-full"/>
						</Flex>
