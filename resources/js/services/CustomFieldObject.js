...
/**
 * Class: Custom Field Object
 * Represents a single Custom Field record
 * @class
 * @classdesc A Custom Field entity as fetched from the database
 * with other functionality to make data handling easier
 */

export default class CustomFieldObject {

	/**
	 * Creates a new CustomFieldObject instance
	 * @param {Object} customFieldData
	 * @throws {TypeError} if customFieldData is not provided
	 */
	constructor(customFieldData) {
		Object.assign(this, customFieldData, {
